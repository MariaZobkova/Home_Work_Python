...
quantity_phrase = int(input('Введите количество фраз в стихотворении: '))

poem = [input('Введите фразу: ') for _ in range(quantity_phrase)]
print(poem)


def vowels (lst):
    help_string = 'аеёиоуыэюя'
    # count_lowel = []
    count_dict = {}
    count = 0
